          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="rounded-md border">
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="font-medium">Mar 15, 2025</TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Mar 12, 2025</TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Mar 10, 2025</TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Mar 8, 2025</TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-green-100">
                          <ArrowUpIcon className="h-3 w-3 text-green-500" />
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Mar 5, 2025</TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Mar 1, 2025</TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-green-100">
                          <ArrowUpIcon className="h-3 w-3 text-green-500" />
